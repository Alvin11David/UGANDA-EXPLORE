            ...
            children: [
              Positioned(
                ...
                child: Image.asset(
                  ...
                  width: 60,
                  height: 60,
                  color: isDarkMode ? null : Colors.black87.withOpacity(0.8),
                ),
              ),
              Positioned(
                top: 100,
              ...
              Positioned(
                ...
                child: SvgPicture.asset(
                  ...
                  width: 160,
                  height: 160,
                  color: isDarkMode ? null : Colors.black54,
                ),
              ),
              Positioned(
                bottom: 0,
...
// To use this, wrap your MaterialApp with Provider
// In your main.dart, do something like this:
/*
void main() {
  runApp(
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/signin': (context) => const SignInScreen(), // Define your SignInScreen
      },
    );
  }
}
